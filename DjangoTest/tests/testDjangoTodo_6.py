...
class DjangoTODOListTestCase(unittest.TestCase):
    ...
    def test40DeleteTask(self):
        self.driver.find_element_by_link_text("Items").click()
        self.driver.find_element_by_link_text("seleniumtest").click()
        self.driver.find_element_by_link_text("Delete").click()
        self.driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='seleniumtest'])[2]/following::input[3]").click()
